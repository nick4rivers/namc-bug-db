...
var sampleOrganismsQuery = 'SELECT * FROM sample.fn_sample_organisms($1)';
exports.getSampleOrganisms = function (pool, sampleId) {
    return pgPromise(pool, sampleOrganismsQuery, [sampleId]);
};
