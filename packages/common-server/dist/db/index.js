...
exports.fnQuery = exports.pgPromise = exports.getPool = void 0;
...
exports.pgPromise = function (pool, query, vars) {
...
exports.fnQuery = function (pool, params) {
    var name = params.name, args = params.args, orderBy = params.orderBy, limit = params.limit, offset = params.offset;
    var paramString = args && args.length > 0 ? "(" + args.map(function (k, idx) { return "$" + (idx + 1); }).join(', ') + ")" : '';
    var orderStr = limit > -1 ? " ORDER BY " + orderBy : '';
    var limitStr = limit > -1 ? " LIMIT " + limit : '';
    var offsetStr = offset > -1 ? " OFFSET " + offset : '';
    var qry = "SELECT * FROM " + name + paramString + orderStr + limitStr + offsetStr;
    return exports.pgPromise(pool, qry, args);
};
