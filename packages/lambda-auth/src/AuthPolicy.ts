import { AuthMethod, AuthStatement, AuthDocument, AuthPolicyDoc, HttpVerb } from './types'
/**
...
class AuthPolicy {
    ...
    constructor(principal: string, awsAccountId: string, apiOptions: { [key: string]: string }) {
        /**
    ...
    addMethod = (effect: string, verb: string, resource: string, conditions): void => {
        ...
        if (methods.length > 0) {
            ...
            for (let i = 0; i < methods.length; i++) {
                ...
                if (curMethod.conditions === null || curMethod.conditions.length === 0) {
                    ...
                    const conditionalStatement: AuthStatement = this.getEmptyStatement(effect)
     ...
     * @return {void}
     */
    allowMethod = (verb: string, resource): void => {
