...
def migrate_samples(mscon, samples_path):
...
def main():
    ...
    parser.add_argument('samples_path', help='Output SQL file', type=str)
    ...
    samples_path = os.path.join(os.path.dirname(__file__), '../docker/postgres/initdb', args.samples_path)

    migrate_samples(mscon, samples_path)
