...
COMMENT ON TABLE geo.countries IS 'Table containing one record for each country in the World.'
    'The geometry column is used to store a multi-polygon of the outline of the country for use '
...
CREATE TRIGGER tr_states_update
    ...
    FOR EACH ROW
EXECUTE PROCEDURE fn_before_update();
COMMENT ON table geo.states IS 'table containing the 50 states of America. The geometry'
