...
CREATE TABLE entity.models
(
    entity_id SMALLINT NOT NULL,
    model_id  SMALLINT NOT NULL,

    CONSTRAINT pk_entity_models PRIMARY KEY (entity_id, model_id),
    CONSTRAINT fk_entity_models_entity_id FOREIGN KEY (entity_id) references entity.entities (entity_id),
    CONSTRAINT fk_entity_models_model_id FOREIGN KEY (model_id) references geo.models (model_id)
);
CREATE INDEX fx_entity_models_model_id ON entity.models (model_id);
...
CREATE TYPE PERTURBATION_DIRECTIONS AS ENUM ('Increase', 'Decrease', 'Increase or decrease');
...
(
    formula_id  INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name        VARCHAR(255) UNIQUE NOT NULL,
    r_function  VARCHAR(100) UNIQUE NOT NULL,
    formula     TEXT,
    description TEXT
);
