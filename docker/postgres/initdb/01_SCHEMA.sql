...
CREATE TABLE organism.taxa_levels(
...
CREATE TABLE organism.taxonomy (
    ...
    CONSTRAINT fk_organism_taxonomy_taxa_level_id FOREIGN KEY (level_id) REFERENCES organism.taxa_levels(level_id)
);
CREATE INDEX fx_organism_taxonomy_taxa_level_id ON organism.taxonomy(level_id);
...
CREATE TABLE organism.synonyms (
    synonym_id          INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    taxa_id             INT NOT NULL,
    synonym             VARCHAR(255) NOT NULL,

    CONSTRAINT fk_synonyms_taxa_id FOREIGN KEY (taxa_id) REFERENCES organism.taxonomy(taxonomy_id)
);
CREATE INDEX fx_synonyms_taxa_id ON organism.synonyms(taxa_id);
