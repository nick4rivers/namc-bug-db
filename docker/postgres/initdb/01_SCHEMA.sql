...
CREATE TRIGGER tr_sumbissions_update BEFORE UPDATE ON sample.submissions FOR EACH ROW EXECUTE PROCEDURE fn_before_update();
...
CREATE TRIGGER tr_asset_types_update BEFORE UPDATE ON sample.asset_types FOR EACH ROW EXECUTE PROCEDURE fn_before_update();
