...
CREATE TABLE taxa.translation_predictors (
    ...
    CONSTRAINT fk_taxa_translation_predictors_translation_id FOREIGN KEY (translation_id) REFERENCES taxa.translations(translation_id),
...
CREATE TABLE sample.mass (
    ...
    CONSTRAINT fk_mass_sample_id FOREIGN KEY (sample_id) REFERENCES sample.samples(sample_id),
...
CREATE TABLE sample.fish (
    ...
    CONSTRAINT fk_fish_sample_id FOREIGN KEY (sample_id) REFERENCES sample.samples(sample_id),
