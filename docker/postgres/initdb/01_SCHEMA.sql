...
CREATE TABLE meta.table_migrations (
    migration_id        SMALLINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    source_table        TEXT NOT NULL,
    target_table_id     SMALLINT NOT NULL,
    description         TEXT,

    CONSTRAINT fk_table_migrations_target_table_id FOREIGN KEY (target_table_id) REFERENCES meta.tables(table_id)
);
CREATE INDEX fx_migrations_target_table_id ON meta.table_migrations(target_table_id);
...
CREATE TABLE billing.line_item_types (
    line_item_type_id   INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE billing.quotes (
    quote_id            SMALLINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    entity_id           SMALLINT NOT NULL,
    ...
    CONSTRAINT fk_quotes_entity_id FOREIGN KEY (entity_id) REFERENCES entity.entities(entity_id)
);
CREATE INDEX fx_billing_quotes ON billing.quotes(entity_id);
...
CREATE TABLE billing.quote_items (
    ...
    CONSTRAINT pk_billing_quote_items PRIMARY KEY (quote_id, line_item_type_id),
    CONSTRAINT fk_quote_items FOREIGN KEY (quote_id) REFERENCES billing.quotes(quote_id),
    CONSTRAINT fk_quote_line_item_type_id FOREIGN KEY (line_item_type_id) REFERENCES billing.line_item_types(line_item_type_id),
